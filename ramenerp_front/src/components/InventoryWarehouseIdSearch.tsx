// src/components/InventoryWarehouseIdSearch.tsx
...
const InventoryWarehouseIdSearch: React.FC<Props> = ({
  value,
  loading,
  onChange,
  onSearch,
...
export default InventoryWarehouseIdSearch;
