...
type Target = { unit_id: number; name: string };
...
const UnitDeleteUI: React.FC<Props> = ({ open, target, onClose, onConfirm }) => {
  ...
  return (
    <div style={overlay} onClick={onClose}>
      <div style={modal} onClick={(e) => e.stopPropagation()}>
        <h3 style={{ margin: "0 0 10px 0", color: "#b91c1c" }}>단위 삭제</h3>
        <div style={row}>정말로 <b>{need}</b> 단위를 삭제하시겠습니까?</div>
